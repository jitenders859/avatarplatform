...
const FALLBACK_TEMPLATES = {
  ...
  "lead_notification": {
    "subject": "New lead captured on \"${escapeHtml(projectName)}\"",
    "body": "\n      <div style=\"font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px\">\n        <h2 style=\"margin:0 0 16px;font-size:20px\">New lead on ${escapeHtml(projectName)}</h2>\n        <p style=\"color:#555;line-height:1.6\">A visitor just filled in your chatbot's lead-capture form.</p>\n        <table style=\"width:100%;border-collapse:collapse;margin:16px 0\">${rowsHtml}</table>\n        <a href=\"${BASE_URL()}/dashboard\" style=\"display:inline-block;margin:24px 0;padding:12px 24px;background:#7c6af5;color:#fff;border-radius:8px;text-decoration:none;font-weight:600\">View in dashboard →</a>\n        <hr style=\"border:none;border-top:1px solid #eee;margin:24px 0\"/>\n        <p style=\"color:#bbb;font-size:11px\">AvatarPlatform · <a href=\"${BASE_URL()}\" style=\"color:#bbb\">${BASE_URL()}</a></p>\n      </div>"
  },
  "tour_booked_notification": {
    "subject": "New tour booked on \"${escapeHtml(projectName)}\"",
    "body": "\n      <div style=\"font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px\">\n        <h2 style=\"margin:0 0 16px;font-size:20px\">New tour on ${escapeHtml(projectName)}</h2>\n        <p style=\"color:#555;line-height:1.6\"><strong>${escapeHtml(visitorName)}</strong> (${escapeHtml(visitorEmail)}) booked a tour for <strong>${escapeHtml(when)}</strong>.</p>\n        ${meetLinkHtml}\n        <a href=\"${BASE_URL()}/dashboard\" style=\"display:inline-block;margin:24px 0;padding:12px 24px;background:#7c6af5;color:#fff;border-radius:8px;text-decoration:none;font-weight:600\">View in dashboard →</a>\n        <hr style=\"border:none;border-top:1px solid #eee;margin:24px 0\"/>\n        <p style=\"color:#bbb;font-size:11px\">AvatarPlatform · <a href=\"${BASE_URL()}\" style=\"color:#bbb\">${BASE_URL()}</a></p>\n      </div>"
  }
};
